...
对vue底层实现原理的认识
vue虚拟DOM diff算法是如何实现的
用vue怎么做页面缓存的

200（from disk cache）和 304：https://blog.csdn.net/u014452812/article/details/79131676

用 JS 生成唯一订单号

Service Worker 在 PWA 中起的作用

动手操作类：

input 输入命中arr中关键字 自动补全autocomplete
